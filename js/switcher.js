...
jQuery(document).ready(function(){
    ...
    var switcherHTML = '<div id="switcher" style="opacity: 0 !important;">';
            ...
            */}
            ...
            $(function() {
                //jQuery('#switcher-version .light').on('click', switcherClass.switchDarkLight);
                jQuery('#switcher-version .light').click(); // Déclenche un clic sur l'élément
                switcherClass.switchDarkLight(); 
            })
            //version switcher
